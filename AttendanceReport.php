...
?>
	<div class="table-responsive">
     ...
     <tbody>
      ...
      $query3 = mysql_query("Select * from tbl_attendance T inner join student_table st on st.std_roll_no=T.StudentRollNumber Where st.student_name like '%%'  group by st.std_roll_no");
/*
